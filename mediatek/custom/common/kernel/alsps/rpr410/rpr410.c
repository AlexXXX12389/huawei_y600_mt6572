...
static struct alsps_hw cust_alsps_hw_rpr400 = {
    ...
    */
    ...
    .als_level  = {1, 50, 200, 400, 600, 800, 1001, 3001, 10001, 20000, 50000, 80000, 100000, 102400, 0},
    .als_value  = {1, 10, 50,  200, 400, 600, 800,  1000, 3000,  10000, 20000, 50000, 80000,  102400, 0, 0},
...
int rpr410_setup_eint(struct i2c_client *client)
{
	...
	mt_eint_registration(CUST_EINT_ALS_NUM, 0, rpr410_eint_func, 0);
