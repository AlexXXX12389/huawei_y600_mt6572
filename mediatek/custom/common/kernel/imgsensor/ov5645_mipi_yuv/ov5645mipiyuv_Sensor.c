...
#define OV5645MIPI_FLASH_BV_THRESHOLD 0x25
static void OV5645MIPI_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
    ...
    if (NormBr > OV5645MIPI_FLASH_BV_THRESHOLD)
    {
...
void OV5645MIPIInitialSetting(void)
{
    ...
    OV5645MIPI_write_cmos_sensor(0x3a19, 0x80);//   ; gain ceiling
    ...
    OV5645MIPI_write_cmos_sensor(0x5481, 0x04);//   ; Y yst 00
    OV5645MIPI_write_cmos_sensor(0x5482, 0x10);//
    OV5645MIPI_write_cmos_sensor(0x5483, 0x20);//
    OV5645MIPI_write_cmos_sensor(0x5484, 0x46);//
    OV5645MIPI_write_cmos_sensor(0x5485, 0x5d);//
    OV5645MIPI_write_cmos_sensor(0x5486, 0x6d);//
    OV5645MIPI_write_cmos_sensor(0x5487, 0x7b);//
    ...
    OV5645MIPI_write_cmos_sensor(0x5588, 0x41);//
    ...
    OV5645MIPI_write_cmos_sensor(0x5800, 0x32);//lsc
    OV5645MIPI_write_cmos_sensor(0x5801, 0x23);//
    OV5645MIPI_write_cmos_sensor(0x5802, 0x16);//
    OV5645MIPI_write_cmos_sensor(0x5803, 0x1e);//
    OV5645MIPI_write_cmos_sensor(0x5804, 0x28);//
    OV5645MIPI_write_cmos_sensor(0x5805, 0x3e);//
    OV5645MIPI_write_cmos_sensor(0x5806, 0x17);//
    OV5645MIPI_write_cmos_sensor(0x5807, 0x0b);//
    OV5645MIPI_write_cmos_sensor(0x5808, 0x0b);//
    OV5645MIPI_write_cmos_sensor(0x5809, 0x0e);//
    OV5645MIPI_write_cmos_sensor(0x580a, 0x10);//
    OV5645MIPI_write_cmos_sensor(0x580b, 0x12);//
    OV5645MIPI_write_cmos_sensor(0x580c, 0x0F);//
    OV5645MIPI_write_cmos_sensor(0x580d, 0x03);//
    OV5645MIPI_write_cmos_sensor(0x580e, 0x05);//
    OV5645MIPI_write_cmos_sensor(0x580f, 0x05);//
    OV5645MIPI_write_cmos_sensor(0x5810, 0x07);//
    OV5645MIPI_write_cmos_sensor(0x5811, 0x0b);//
    OV5645MIPI_write_cmos_sensor(0x5812, 0x09);//
    OV5645MIPI_write_cmos_sensor(0x5813, 0x03);//
    OV5645MIPI_write_cmos_sensor(0x5814, 0x01);//
    OV5645MIPI_write_cmos_sensor(0x5815, 0x03);//
    OV5645MIPI_write_cmos_sensor(0x5816, 0x05);//
    OV5645MIPI_write_cmos_sensor(0x5817, 0x0a);//
    OV5645MIPI_write_cmos_sensor(0x5818, 0x13);//
    OV5645MIPI_write_cmos_sensor(0x5819, 0x10);//
    OV5645MIPI_write_cmos_sensor(0x581a, 0x0b);//
    OV5645MIPI_write_cmos_sensor(0x581b, 0x0b);//
    OV5645MIPI_write_cmos_sensor(0x581c, 0x10);//
    OV5645MIPI_write_cmos_sensor(0x581d, 0x23);//
    OV5645MIPI_write_cmos_sensor(0x581e, 0x3c);//
    OV5645MIPI_write_cmos_sensor(0x581f, 0x17);//
    OV5645MIPI_write_cmos_sensor(0x5820, 0x17);//
    OV5645MIPI_write_cmos_sensor(0x5821, 0x17);//
    OV5645MIPI_write_cmos_sensor(0x5822, 0x20);//
    ...
    OV5645MIPI_write_cmos_sensor(0x5827, 0x08);//
    OV5645MIPI_write_cmos_sensor(0x5828, 0x4a);//
    OV5645MIPI_write_cmos_sensor(0x5829, 0x24);//
    OV5645MIPI_write_cmos_sensor(0x582a, 0x04);//
    OV5645MIPI_write_cmos_sensor(0x582b, 0x22);//
    OV5645MIPI_write_cmos_sensor(0x582c, 0x06);//
    OV5645MIPI_write_cmos_sensor(0x582d, 0x24);//
    OV5645MIPI_write_cmos_sensor(0x582e, 0x0a);//
    OV5645MIPI_write_cmos_sensor(0x582f, 0x22);//
    OV5645MIPI_write_cmos_sensor(0x5830, 0x20);//
    OV5645MIPI_write_cmos_sensor(0x5831, 0x23);//
    OV5645MIPI_write_cmos_sensor(0x5832, 0x0a);//
    OV5645MIPI_write_cmos_sensor(0x5833, 0x27);//
    OV5645MIPI_write_cmos_sensor(0x5834, 0x06);//
    OV5645MIPI_write_cmos_sensor(0x5835, 0x15);//
    OV5645MIPI_write_cmos_sensor(0x5836, 0x04);//
    OV5645MIPI_write_cmos_sensor(0x5837, 0x27);//
    OV5645MIPI_write_cmos_sensor(0x5838, 0x6a);//
    OV5645MIPI_write_cmos_sensor(0x5839, 0x2A);//
    OV5645MIPI_write_cmos_sensor(0x583a, 0x0c);//
    OV5645MIPI_write_cmos_sensor(0x583b, 0x2a);//
    OV5645MIPI_write_cmos_sensor(0x583c, 0x6a);//
    ...
    OV5645MIPI_write_cmos_sensor(0x5384, 0x0b); //width=256  
    OV5645MIPI_write_cmos_sensor(0x5385, 0x84);
    OV5645MIPI_write_cmos_sensor(0x5386, 0x8f); //heght=256
    ...
    OV5645MIPI_write_cmos_sensor(0x5187, 0x23);
    OV5645MIPI_write_cmos_sensor(0x5188, 0x28);
    OV5645MIPI_write_cmos_sensor(0x5189, 0x7A);
    OV5645MIPI_write_cmos_sensor(0x518A, 0x67);
    OV5645MIPI_write_cmos_sensor(0x518B, 0xF0);
    OV5645MIPI_write_cmos_sensor(0x518C, 0xAA);
    OV5645MIPI_write_cmos_sensor(0x518D, 0x3E);
    OV5645MIPI_write_cmos_sensor(0x518E, 0x1D);
    OV5645MIPI_write_cmos_sensor(0x518F, 0x50);
    ...
    OV5645MIPI_write_cmos_sensor(0x519B, 0x7A);
    OV5645MIPI_write_cmos_sensor(0x519C, 0x09);
    OV5645MIPI_write_cmos_sensor(0x519D, 0xF4);
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
    ...
    OV5645MIPI_write_cmos_sensor(0x380c, 0x07);//   ; HTS = 2160
    OV5645MIPI_write_cmos_sensor(0x380d, 0x68);//   ; HTS
    OV5645MIPI_write_cmos_sensor(0x380e, 0x04);//   ; VTS = 740
    OV5645MIPI_write_cmos_sensor(0x380f, 0x9c);//   ; VTS
    OV5645MIPI_write_cmos_sensor(0x3810, 0x00); // H OFF = 16
    OV5645MIPI_write_cmos_sensor(0x3811, 0x10); // H OFF
    OV5645MIPI_write_cmos_sensor(0x3812, 0x00); // V OFF = 4
    OV5645MIPI_write_cmos_sensor(0x3813, 0x06);//   ; V OFF
    ...
    OV5645MIPI_write_cmos_sensor(0x5583, 0x38);//
    OV5645MIPI_write_cmos_sensor(0x5584, 0x38);//
    OV5645MIPI_write_cmos_sensor(0x5580, 0x06);//
    OV5645MIPI_write_cmos_sensor(0x5587, 0x08);//
    OV5645MIPI_write_cmos_sensor(0x5588, 0x49);//
    OV5645MIPI_write_cmos_sensor(0x3a0f, 0x29);//
    OV5645MIPI_write_cmos_sensor(0x3a10, 0x23);//
    OV5645MIPI_write_cmos_sensor(0x3a11, 0x52);//
    OV5645MIPI_write_cmos_sensor(0x3a1b, 0x29);//
    OV5645MIPI_write_cmos_sensor(0x3a1e, 0x23);//
    OV5645MIPI_write_cmos_sensor(0x3a1f, 0x11);//
    OV5645MIPI_write_cmos_sensor(0x5302, 0x20);//
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
    ...
    OV5645MIPI_write_cmos_sensor(0x4202, 0x0f);//   ; stop mipi stream
    mDELAY(40);
    OV5645MIPI_write_cmos_sensor(0x3a02, 0x03);//   ; ae mode   
    OV5645MIPI_write_cmos_sensor(0x3a03, 0xD8);//   ; MIPI 2 lane
    OV5645MIPI_write_cmos_sensor(0x3a14, 0x03); //PLL, MIPI 8-bit mode
    ...
    OV5645MIPI_write_cmos_sensor(0x5303, 0x18); //
    OV5645MIPI_write_cmos_sensor(0x5306, 0x18); //
    OV5645MIPI_write_cmos_sensor(0x5307, 0x1C); //
    if(run_test_potten)
    {
...
UINT32 OV5645MIPIOpen(void)
{
    ...
    mDELAY(10);
    OV5645MIPI_write_cmos_sensor(0x3000,0x00);
    OV5645MIPI_write_cmos_sensor(0x3004,0x10);
    OV5645MIPI_write_cmos_sensor(0x3D00,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D01,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D02,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D03,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D04,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D05,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D06,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D07,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D08,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D09,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D0A,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D0B,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D0C,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D0D,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D0E,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D0F,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D10,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D11,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D12,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D13,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D14,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D15,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D16,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D17,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D18,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D19,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D1A,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D1B,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D1C,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D1D,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D1E,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D1F,0x00);
    OV5645MIPI_write_cmos_sensor(0x3D20,0x00);
...
UINT32 OV5645MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,MSDK_SENSOR_INFO_STRUCT *pSensorInfo,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->SensorPreviewResolutionX=1280;
    pSensorInfo->SensorPreviewResolutionY=958;
    if (ScenarioId==MSDK_SCENARIO_ID_CAMERA_ZSD)
        pSensorInfo->SensorCameraPreviewFrameRate=15;
    else
        pSensorInfo->SensorCameraPreviewFrameRate=30;
    pSensorInfo->SensorFullResolutionX=2590;
    pSensorInfo->SensorFullResolutionY=1940;
    ...
    pSensorInfo->SensorHsyncPolarity = SENSOR_CLOCK_POLARITY_HIGH;  //0
    pSensorInfo->SensorVsyncPolarity = SENSOR_CLOCK_POLARITY_LOW;//1
    pSensorInfo->SensroInterfaceType=SENSOR_INTERFACE_TYPE_MIPI;//1
    ...
    pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_8MA;//3
    pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_YUYV;//6 
...
UINT32 OV5645MIPIYUVSetVideoMode(UINT16 u2FrameRate)
{
    ...
    if (u2FrameRate == 30)
    {
        ...
        OV5645MIPI_write_cmos_sensor(0x350c, 0x00);//
        OV5645MIPI_write_cmos_sensor(0x350d, 0x00);//
        OV5645MIPI_write_cmos_sensor(0x5302, 0x04);//
        if(run_test_potten)
        {
            run_test_potten=0;
            OV5645SetTestPatternMode(1);
