...
static u32 mainCamAFPowerFlag = 0;
...
int kdCISModulePowerOn(CAMERA_DUAL_CAMERA_SENSOR_ENUM SensorIdx, char *currSensorName, BOOL On, char* mode_name)
{
    ...
    if (On) {
        ...
        if (currSensorName && ((0 == strcmp(SENSOR_DRVNAME_OV5646_MIPI_YUV,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_OV5645_MIPI_YUV,currSensorName))))
        {
            PK_DBG("[CAMERA SENSOR] kdCISModulePowerOn get in---OV5646_MIPI_YUV or OV5645_MIPI_YUV sensorIdx:%d; pinSetIdx=%d\n",SensorIdx, pinSetIdx);
       ...
       {  
          PK_DBG("[CAMERA SENSOR] kdCISModulePowerOn get in---GC0329_YUV sensorIdx:%d; pinSetIdx=%d\n",SensorIdx, pinSetIdx);
